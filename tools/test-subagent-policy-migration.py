...
def assert_unambiguous_entrypoint(text: str) -> None:
    ...
    required = [
        ...
        "Не запускайте процедуру настройки и не запрашивайте подтверждение её целей, если пользователь не поручил настроить, изменить или проверить саму политику.",
