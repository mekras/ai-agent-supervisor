...
- политика целевого проекта — `AGENTS.md`, `SUBAGENTS.md`, `CLAUDE.md`, другой
  проектный файл или пользовательский слой;
...
2. Собери контекст целевой среды: существующие `AGENTS.md`/`SUBAGENTS.md`,
   `CLAUDE.md`, `.codex/`, `~/.codex`, профили, global agents, скрипты
   `tools/codex-*`, доступные модели, лимиты, правила проекта и источники
   истины.
...
4. Реши, где должна жить политика: глобальный пользовательский слой, проектный
   файл, `AGENTS.md`, отдельный `SUBAGENTS.md` или их сочетание. Если проект
   использует Claude, отдельно проверь точку входа `CLAUDE.md`: она не должна
   становиться вторым расходящимся источником политики и обычно должна
   отсылать к `AGENTS.md` или совместимой проектной инструкции. В `AGENTS.md`
...
- если проект использует Claude — как `CLAUDE.md` связан с `AGENTS.md` или
  другим файлом политики;
