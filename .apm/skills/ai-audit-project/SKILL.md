...
4. Построй карту правил: файл, область действия, способ доставки в контекст,
   адресат, приоритет, повторяемые темы, обязательность, срок жизни и связь с
   инструментами.
...
7. В режиме диагностики не исправляй подтверждённые проблемы. Для каждой
