...
4. Проверь проблемы: дубли, противоречия, неоднозначности, непроверяемые
   ...
   проверь объявленную `scripts.tests`; если доступны публичные Python-скрипты
   и оснастка `ai-setup-apm`, отсутствие их исполнимых контрактов — отдельная
   находка, а не причина пропустить её из-за успешных ранних этапов команды.
