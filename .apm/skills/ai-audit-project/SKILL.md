...
2. До вывода о полноте запусти доступный
   ...
   сценариев к отсутствующим путям внутри фикстур. Такой путь, не объявленный
   в `inputs` покрываемой операции, детерминированно опровергает пустой массив.
   Перенеси найденные пути и результат команды в карту операций.
