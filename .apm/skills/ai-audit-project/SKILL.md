...
2. Для каждого скрипта нужен хотя бы один успешный рабочий сценарий. Ожидаемый
   отказ вспомогательной команды не подтверждает основной путь.
3. Сопоставь команды, прямо указанные в процедуре навыка, с командами
   контракта.
