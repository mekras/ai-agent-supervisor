...
2. Маршрутизируй задачу по типу:
   ...
   - настройка клиентского контура (подключение агента, `AGENTS.md`, правила
     проекта) → не выполняй здесь, верни в `ait-setup`,
     `ai-agents-md-maintenance` или клиентские инструкции проекта. При
     подключённом `ai-dev-team` сначала работай с проектом как с клиентом.
...
- почему эта часть не выполняется внутри `ai-apm-setup`.
