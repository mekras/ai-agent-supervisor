...
15. Если проект использует автоматическую проверку бюджета `description`,
    обнови её вместе с правкой и не оставляй описание длиннее, чем нужно для
    маршрутизации.
16. Если постоянный тест нельзя создать в текущей задаче, явно укажи, какого
...
17. Перед созданием или изменением навыка проверь, не дешевле ли решить задачу
   локальной проектной инструкцией вместо нового или расширенного навыка.
18. Если изменение создаёт или меняет текст, предназначенный для человека,
