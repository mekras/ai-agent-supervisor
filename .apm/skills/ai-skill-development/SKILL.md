...
7б. Для каждого публичного Python-скрипта P1 первого уровня в `scripts/`
   ...
   проверки кода. Контрактный запускатель наблюдает проверки отсутствующих
   путей внутри успешной фикстуры, исключает пути, созданные или заменённые
   самой операцией, и отклоняет оставшиеся необъявленные пути. Отсутствие поля
   не считается завершённой инвентаризацией.
   Подключи
