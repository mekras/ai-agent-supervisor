...
description: >
  ...
  инструкций для ИИ, а также похожие источники. Применяй для поиска дублей,
...
ссылки, человеко-ориентированную документацию как контекст и проектные правила,
...
2. Найди источники правил. Начни с `AGENTS.md` и известных файлов инструкций
   ...
   как человеко-ориентированный контекст, описание интерфейса навыка и место,
