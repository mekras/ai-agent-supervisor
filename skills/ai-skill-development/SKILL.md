...
7. Синхронизируй `agents/openai.yaml`, если он есть или нужен для интерфейса
   навыка.
8. Добавь или обнови `evals/triggers.json`, если меняется `description`,
   область применения или границы с соседними навыками.
9. Для создаваемого или существенно изменяемого навыка создай постоянные тесты
   либо явно предложи их добавить. Выбери виды тестов по риску изменения:
   срабатывание, качество результата, регрессии, негативные ограничения,
   проверку скриптов и интеграцию с проектными правилами.
10. Перед созданием или изменением навыка проверь, не дешевле ли решить задачу
   локальной проектной инструкцией вместо нового или расширенного навыка.
11. Если изменение создаёт или меняет текст, предназначенный для человека,
