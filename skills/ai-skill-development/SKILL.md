...
9. Если тестов нет, они устарели, их не хватает или навык меняется, создай либо
   обнови постоянные тесты в рамках текущей правки.
10. Добавь или обнови `evals/triggers.json`, если меняется `description`,
    область применения или границы с соседними навыками.
11. Если постоянный тест нельзя создать в текущей задаче, явно укажи, какого
...
12. Перед созданием или изменением навыка проверь, не дешевле ли решить задачу
   локальной проектной инструкцией вместо нового или расширенного навыка.
13. Если изменение создаёт или меняет текст, предназначенный для человека,
